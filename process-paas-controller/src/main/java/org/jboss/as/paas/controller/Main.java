...
//        System.out.println("    --version                           Print version and exit\n");
    ...
    public static final String PAAS_CONTROLLER_PROCESS_NAME = "PaaS Controller";
    public static final String PAAS_CONTROLLER_MODULE = "org.jboss.as.paas-controller";

    static ProcessController processController;

    public static void main(String[] args) throws IOException {
        processController = org.jboss.as.process.Main.start(args);

        start(args);
    }

    public static ProcessController start(String[] args) throws IOException {
        MDC.put("process", "process paas controller");
        ...
        String bootModule = PAAS_CONTROLLER_MODULE;
...
//                    //TODO((ConsoleHandler)consoleHandler).setWriter(new SynchronizedWriter(System.out));
//                }
//            }
//        }
//
        ...
        final ThreadFactory threadFactory = new JBossThreadFactory(new ThreadGroup("ProcessPaasController-threads"), Boolean.FALSE, null, "%G - %t", null, null, AccessController.getContext());
...
//
        ...
        processController.addProcess(PAAS_CONTROLLER_PROCESS_NAME, initialCommand, Collections.<String, String>emptyMap(), currentWorkingDir, true);
        processController.startProcess(PAAS_CONTROLLER_PROCESS_NAME);
